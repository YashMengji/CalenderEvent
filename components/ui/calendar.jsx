    ...
    <div className="scale-125"> {/* Adjust scale as needed */}
      <DayPicker
        ...
        classNames={{
          ...
          head_row: "flex gap-2",
          head_cell:
            "text-neutral-500 rounded-md w-8 font-normal text-[1rem]  dark:text-neutral-400", // Adjust text size
          ...
          day: cn(
            ...
            "h-10 w-10 p-0 font-medium aria-selected:opacity-100" // Adjust button size
          ),
          ...
          day_today:
            "bg-gray-500 text-white dark:bg-neutral-800 dark:text-neutral-50",
          day_outside:
        ...
        components={{
          IconLeft: ({ ...props }) => <ChevronLeft className="h-5 w-5" />, // Adjust icon size
          IconRight: ({ ...props }) => <ChevronRight className="h-5 w-5" />, // Adjust icon size
        }}
        {...props}
      />
    </div>
